				...
				<ul class="nav ace-nav">
						...
						<ul
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									...
									<li><a href="#">
											<div class="clearfix">
												<span class="pull-left">Bug 修复</span> <span
					...
					<li class="purple dropdown-modal"><a data-toggle="dropdown"
						...
						<ul
							...
							<li class="dropdown-header"><i
								class="ace-icon fa fa-exclamation-triangle"></i> 8 示警</li>
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar navbar-pink">
									...
									<li><a href="#"> <i
											class="btn btn-xs btn-primary fa fa-user"></i> 鲍勃刚报名当编辑.
									</a></li>
									...
									<li><a href="#">
											<div class="clearfix">
												<span class="pull-left"> <i
													class="btn btn-xs no-hover btn-info fa fa-twitter"></i> 用户
					...
					<li class="green dropdown-modal"><a data-toggle="dropdown"
						...
						<ul
								...
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#" class="clearfix"> <img
											...
											alt="Alex's Avatar" /> <span class="msg-body"> <span
												class="msg-title"> <span class="blue">贾晓丽：</span>
													我要吃饭
											</span> <span class="msg-time"> <i
													class="ace-icon fa fa-clock-o"></i> <span>一分钟以前</span>
											</span>
										</span>
									</a></li>
									...
									<li><a href="#" class="clearfix"> <img
											...
											alt="Susan's Avatar" /> <span class="msg-body"> <span
												class="msg-title"> <span class="blue">小宝宝：</span>
													我要吃饭
											</span> <span class="msg-time"> <i
													class="ace-icon fa fa-clock-o"></i> <span>20分钟以前</span>
											</span>
										</span>
									</a></li>
							...
							<li class="dropdown-footer"><a href="inbox.html"> 查看所有信息
					...
					<li class="light-blue dropdown-modal"><a
						...
						<ul
							...
							<li><a href="profile.html"> <i
									class="ace-icon fa fa-user"></i> 人物简介
							</a></li>
		...
		<div id="sidebar" class="sidebar   responsive   ace-save-state">
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						<li class=""><a href="#" class="dropdown-toggle"> <i
								class="menu-icon fa fa-caret-right"></i> 系统配置 <b
								class="arrow fa fa-angle-down"></b>
						</a> <b class="arrow"></b>

							<ul class="submenu">
								<li class=""><a href="top-menu.html"> <i
										class="menu-icon fa fa-caret-right"></i> 参数配置01
								</a> <b class="arrow"></b></li>

								<li class=""><a href="two-menu-1.html"> <i
										class="menu-icon fa fa-caret-right"></i> 参数配置02
								</a> <b class="arrow"></b></li>
							</ul></li>
						<li class=""><a href="typography.html"> <i
								class="menu-icon fa fa-caret-right"></i> 日志管理
						</a> <b class="arrow"></b></li>
						<li class=""><a href="#" class="dropdown-toggle"> <i
								class="menu-icon fa fa-caret-right"></i> 用户管理 <b
								class="arrow fa fa-angle-down"></b>
						</a> <b class="arrow"></b>
